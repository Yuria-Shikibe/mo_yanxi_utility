...
using refable_tuple_decay_ref = std::conditional_t<
	std::is_lvalue_reference_v<Ty>, def_reference_wrapper<std::remove_reference_t<Ty>>, std::decay_t<Ty>>;
...
export
template <typename... Ts>
constexpr refable_tuple<refable_tuple_decay_ref<std::unwrap_ref_decay_t<Ts>>...> make_refable_tuple(
	Ts&&... args) noexcept{
